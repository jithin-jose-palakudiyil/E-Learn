...
<head>
	...
	<title><?php  if (isset($page_title)){ echo $page_title; } ?></title>
        <link href="Modules/BackEnd/Resources/assets/global_assets/css/icons/icomoon/styles.css" rel="stylesheet" type="text/css"/>
	<!-- Global stylesheets -->
	...
	<!-- /theme JS files -->
        <style>
            .AbsoluteCenter { margin: auto; position: absolute;  max-height: 480px; top: 0; left: 0; bottom: 0; right: 0; }
        </style>
</head>
		...
		<div class="page-content">
			...
			<div class="content-wrapper">
				...
				<div class="content pb-20">
					...
					<!-- Advanced login -->
					<form action="{{URL::to(admin_prefix.'/login')}}" method="post" autocomplete="off" id="login_admin">
